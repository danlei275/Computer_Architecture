...
add wave -noupdate -radix decimal /lab5_testbench/data_out
add wave -noupdate /lab5_testbench/clk
add wave -noupdate /lab5_testbench/reset
add wave -noupdate /lab5_testbench/cycles
add wave -noupdate /lab5_testbench/dummy_data
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {11013407 ps} 0}
...
update
WaveRestoreZoom {10773734 ps} {11260330 ps}
